...
var ActionCardWidget = function (_a) {
    var classNames = _a.classNames;
    var _b = React.useState(false), isOpen = _b[0], setOpen = _b[1];
    var _c = React.useState(null), currentData = _c[0], setCurrentData = _c[1];
    ...
    return (React__default["default"].createElement("div", null, currentData ? (React__default["default"].createElement(React__default["default"].Fragment, null,
        React__default["default"].createElement("div", { className: "action-box-card widget-card ".concat(classNames) },
            React__default["default"].createElement(IdeaIcon, null),
